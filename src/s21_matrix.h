...
int s21_sub_matrix(matrix_t *A, matrix_t *B, matrix_t *result);  // leaks isn't
int s21_mult_number(matrix_t *A, double number,
                    matrix_t *result);                            // leaks isn't
int s21_mult_matrix(matrix_t *A, matrix_t *B, matrix_t *result);  // leaks isn't
int s21_transpose(matrix_t *A, matrix_t *result);                 // leaks isn't
int s21_calc_complements(matrix_t *A, matrix_t *result);          // leaks isn't
int s21_determinant(matrix_t *A, double *result);                 // leaks isn't
